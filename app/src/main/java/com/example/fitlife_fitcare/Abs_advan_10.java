...
public class Abs_advan_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            isRunning = false;
            Intent intent = new Intent(Abs_advan_10.this, Finish.class);
        ...
        backbutton.setOnClickListener(v -> {
            ...
            countDownTimer.cancel();
            isRunning = false;
            Intent intent = new Intent(Abs_advan_10.this, Abs_advan_9.class);
            startActivity(intent);
            finish();
        });
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent1 = new Intent(Abs_advan_10.this, Finish.class);
