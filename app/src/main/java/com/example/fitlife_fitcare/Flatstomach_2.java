...
public class Flatstomach_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flatstomach2);
        EdgeToEdge.enable(this);
        timerText = findViewById(R.id.Flatstomachtime2);
        ...
        nextButton.setOnClickListener(v -> {
            ...
            isRunning = false;
            Intent intent = new Intent(Flatstomach_2.this, Flatstomach_3.class);
