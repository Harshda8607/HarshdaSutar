...
public class office_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerText = findViewById(R.id.officetime5);
        progressBar = findViewById(R.id.officeprogressBar5);
        playPauseButton = findViewById(R.id.officePauseButton5);
        nextButton = findViewById(R.id.officeNextButton5);
        back=findViewById(R.id.back_office5);
        ...
        back.setOnClickListener(v -> {
            countDownTimer.cancel();
            isRunning = false;
            Intent intent = new Intent(office_5.this, Dashboard.class);
            startActivity(intent);
            finish();
        });
