...
public class anglebooty_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anglebooty2);

        timerText = findViewById(R.id.bootytime2);
        ...
        back.setOnClickListener(v -> {
            countDownTimer.cancel();
            isRunning = false;
            Intent intent = new Intent(anglebooty_2.this, anglebooty_1.class);
            startActivity(intent);
            finish();
        });
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent1 = new Intent(anglebooty_2.this, anglebooty_3.class);
