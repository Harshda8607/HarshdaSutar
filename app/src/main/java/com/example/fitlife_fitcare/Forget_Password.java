...
public class Forget_Password extends AppCompatActivity {
    ...
    private void updatePassword(String email, String password,String confirmPassword) {
        ...
        try {
            ...
            String encodedConfirmPassword= URLEncoder.encode(confirmPassword,"UTF-8");

            String url = "http://training.testproject.info/9_AM_Batch/FitLife_firCare/password_update.php?Email_ID=" + encodedEmail + "&Password=" + encodedPassword +"&Confirm_Password=" +encodedConfirmPassword;
