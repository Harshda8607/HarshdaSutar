...
public class Fullbody_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fullbody6);
        timerText = findViewById(R.id.fulltimer6);
        ...
        nextButton.setOnClickListener(v -> {
            ...
            isRunning = false;
            Intent intent = new Intent(Fullbody_6.this, Fullbody_7.class);
