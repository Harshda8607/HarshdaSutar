...
public class Thigh_begin_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            isRunning = false;
            Intent intent = new Intent(Thigh_begin_5.this, Thigh_begin_6.class);
        ...
        backbutton.setOnClickListener(v -> {
            ...
            countDownTimer.cancel();
            isRunning = false;
            Intent intent = new Intent(Thigh_begin_5.this, Thigh_begin_4.class);
            startActivity(intent);
            finish();
        });
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent1 = new Intent(Thigh_begin_5.this, Thigh_begin_6.class);
