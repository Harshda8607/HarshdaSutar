...
public class Arm_begin_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            isRunning = false;
            Intent intent = new Intent(Arm_begin_4.this, Arm_begin_5.class);
        ...
        backbutton.setOnClickListener(v -> {
            ...
            countDownTimer.cancel();
            isRunning = false;
            Intent intent = new Intent(Arm_begin_4.this, Arm_begin_3.class);
            startActivity(intent);
            finish();
        });
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent1 = new Intent(Arm_begin_4.this, Arm_begin_5.class);
