...
public class lazybed_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lazybed7);

        timerText = findViewById(R.id.lazytime7);
        ...
        back.setOnClickListener(v -> {
            countDownTimer.cancel();
            isRunning = false;
            Intent intent = new Intent(lazybed_7.this, lazybed_6.class);
            startActivity(intent);
            finish();
        });
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent1=new Intent(lazybed_7.this,lazybed_8.class);
